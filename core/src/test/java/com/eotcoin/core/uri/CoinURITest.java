...
import com.eotcoin.core.coins.BitcoinTest;
import com.eotcoin.core.coins.CoinType;
import com.eotcoin.core.coins.DashMain;
...
import com.eotcoin.core.coins.NuSharesMain;
...
//        assertEquals(BTC, uri.getType());
    ...
    public void testAddressRequest() throws Exception {
        ...
        assertNull(uri.getAddress());
        assertEquals(BTC, uri.getType());
        assertEquals("https://eotcoin.com", uri.getAddressRequestUri().toString());
        assertEquals("https://eotcoin.com?address=" + MAINNET_GOOD_ADDRESS,
        ...
        assertNull(uri.getAddress());
        assertEquals(BTC, uri.getType());
        assertEquals("https://eotcoin.com/some-path?abc=xyz", uri.getAddressRequestUri().toString());
        assertEquals("https://eotcoin.com/some-path?abc=xyz&address=" + MAINNET_GOOD_ADDRESS,
                uri.getAddressRequestUriResponse(MAINNET_GOOD_ADDRESS).toString());
        ...
        assertEquals("https://eotcoin.com", uri.getAddressRequestUri().toString());
        assertEquals("https://eotcoin.com?address=" + goodAddressStr,
