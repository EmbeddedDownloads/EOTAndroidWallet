...
import com.eotcoin.core.coins.FiatType;
import com.eotcoin.core.coins.Value;
import com.eotcoin.core.coins.ValueType;
...
import com.eotcoin.core.uri.CoinURI;
import com.eotcoin.core.uri.CoinURIParseException;
import com.eotcoin.core.util.ExchangeRate;
import com.eotcoin.core.util.GenericUtils;
import com.eotcoin.core.wallet.WalletAccount;
import com.eotcoin.core.wallet.exceptions.NoSuchPocketException;
import com.eotcoin.wallet.AddressBookProvider;
import com.eotcoin.wallet.Configuration;
import com.eotcoin.wallet.Constants;
import com.eotcoin.wallet.ExchangeRatesProvider;
import com.eotcoin.wallet.R;
import com.eotcoin.wallet.WalletApplication;
import com.eotcoin.wallet.tasks.MarketInfoPollTask;
import com.eotcoin.wallet.ui.widget.AddressView;
import com.eotcoin.wallet.ui.widget.AmountEditView;
import com.eotcoin.wallet.util.ThrottlingWalletChangeListener;
import com.eotcoin.wallet.util.UiUtils;
...
import static com.eotcoin.core.coins.Value.canCompare;
import static com.eotcoin.wallet.ExchangeRatesProvider.getRates;
import static com.eotcoin.wallet.util.UiUtils.setGone;
import static com.eotcoin.wallet.util.UiUtils.setVisible;
    ...
    private final LoaderCallbacks<Cursor> rateLoaderCallbacks = new LoaderManager.LoaderCallbacks<Cursor>() {
        ...
        public void onLoadFinished(final Loader<Cursor> loader, final Cursor data) {
            if (data != null && data.getCount() > 0) {
                HashMap<String, com.eotcoin.core.util.ExchangeRate> rates = new HashMap<>(data.getCount());
                data.moveToFirst();
                do {
